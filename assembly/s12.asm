...
ll1:
mov ah, 0x01
int 0x16;-->If a keystroke is present, it is not removed from the keyboard buffer

call move
mov cx, 01h;;interval in microsec
mov dx, 0h
mov ah, 86h
int 15h; -- > used for putting delay-->delay between random number generation 
